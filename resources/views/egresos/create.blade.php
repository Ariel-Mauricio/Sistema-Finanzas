...
<div class="page-header">
    ...
    <p class="page-subtitle">Complete los datos del gasto</p>
</div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('proveedor') is-invalid @enderror" 
                                   name="proveedor" value="{{ old('proveedor') }}" required>
                            @error('proveedor')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="ruc_proveedor" 
                                   value="{{ old('ruc_proveedor') }}" maxlength="20">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">$</span>
                                <input type="text" class="form-control fw-bold text-danger" id="total" readonly value="0.00">
                            </div>
                        </div>
                    </div>
                </div>
